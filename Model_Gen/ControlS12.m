function [dEncTheta dEncPhi EncPhi EncTheta dTheta1 dTheta2 EncX EncY Theta Phi dTheta dPhi dThetaX dThetaY ControlSigX ControlSigY Time Ms_1 Ms_2]=ControlS12(eTheta,ePhi,ExecTime)
...
%   Correcting for jumps in encoder:
    ...
    EncTheta(i) = (EncTheta(i) + 5.672000000238419e+003)*(6.367308821541894e-004)-3.77;
...
dPhi(i) = dEncPhi(i);
    ...
    %Controller
    [u1 u2 tau1 tau2 v1 v2 gravity KpTheta KdTheta vv1 vv2]=PERAPBCController_Magnetic_ShoulderM(Theta(i),Phi(i),eTheta,ePhi,dTheta(i),dPhi(i),itheta(i),iphi(i));
